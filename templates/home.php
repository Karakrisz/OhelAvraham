    ...
    <div class="splide__track">
        <ul class="splide__list">
            <li class="splide__slide position-relative">
                <img class="splide__slide__img" src="Boaz/img/slider.jpg" alt="Ohel Avraham">
                <div class="splide__slide__bg-box position-absolute linear-gradient"></div>
                <div class="splide__slide__text-box position-absolute">
                    <h1 class="splide__slide__text-box__h1">Shabbati menü</h1>
                    <h2 class="splide__slide__text-box__h2">Fűszeres pulykasült</h2>
                    <h3 class="splide__slide__text-box__h3">bécsi salátával</h3>
                    <p class="splide__slide__text-box__p"><i class="splide__slide__text-box__p__i">Mindenkit szeretettel
                            várunk</i></p>
                    <p class="splide__slide__text-box__p"><i class="splide__slide__text-box__p__i">2022.12.03</i></p>
                </div>
            </li>
...
<!-- post-banner start -->
<section>
    <div class="post-banner-area-3 bg-gray pd-top-30 pd-bottom-40">
        <div class="container">
            <div class="row justify-content-center">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-6">
                            <div class="top-post-wrap top-post-wrap-4">
                                <div class="thumb">
                                    ...
                                    <iframe src="https://www.youtube.com/embed/OAjFqX6B5VE" title="YouTube video player"
                                        frameborder="0"
                                ...
                                <div class="top-post-details">
                                    ...
                                    <h6><a>
                                            Csütörtöki tanulás: A megtérés 10 napja és vegyes
                                        </a></h6>
                                    <div class="meta">
                                        <div class="date">
                                            <i class="fa fa-clock-o"></i> 2022. okt. 6.
                                        </div>
                                        <a href="#" class="author">
                                            <i class="fa fa-user"></i> Fináli Gábor
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12 col-md-6">
                            <div class="top-post-wrap top-post-wrap-4">
                                <div class="thumb">
                                    <div class="overlay"></div>
                                    <iframe src="https://www.youtube.com/embed/EBAvyxjHW9A" title="YouTube video player"
                                        frameborder="0"
                                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                        allowfullscreen></iframe>
                                </div>
                                <div class="top-post-details">
                                    ...
                                    <h6><a>Geostrategia, Izrael következő háborújának kihívásai (folytatás) +
                                            beszélgetés
                                        </a></h6>
                                    <div class="meta">
                                        <div class="date">
                                            <i class="fa fa-clock-o"></i> 2022. szept. 16.
                                        </div>
                                        <a href="#" class="author">
                                            <i class="fa fa-user"></i> Fináli Gábor
                                        </a>
                ...
                <div class="col-lg-8">
                    <div class="top-post-wrap top-post-wrap-4 top-post-wrap-4--height-formating">
                        <div class="thumb">
                            <div class="overlay"></div>
                            <iframe src="https://www.youtube.com/embed/pFLxHI__-AE" title="YouTube video player"
                                frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowfullscreen></iframe>
                        </div>
                        <div class="top-post-details">
                            ...
                            <a class="tag tag-blue mb-3 ml-2" href="#">Dress</a>
                            <h4 class="text-white"><a> Biblikus földrajz és modern geo -strategia </a></h4>
                            <div class="meta">
                                <div class="date">
                                    <i class="fa fa-clock-o"></i> 2022. szept. 16.
                                </div>
...
<section>
    <div class="hot-news-area pd-bottom-40" id="szombati-jelentkezes">
        <div class="container">
            <div class="section-title section-title-4 style-3 linear-gradient">
                <div class="row">
                    <div class="col-md-6">
...
<section>
    <div class="top-story-area pd-top-70 pd-bottom-40" id="hetfoi-orak">
        <div class="container">
            <div class="section-title section-title-4 linear-gradient">
                <div class="row">
                    <div class="col-sm-8">
                        <h5 class="title">Talmud, Tóra</h5>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="top-post-wrap top-post-wrap-4 monday-lessons">
                        <div class="thumb">
                            ...
                            <iframe src="https://www.youtube.com/embed/pA0i-jjCTLk" title="YouTube video player"
                                frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowfullscreen></iframe>
                        </div>
                        <div class="top-post-details">
                            <a class="tag" href="#">Love Care</a>
                            <h6><a href="#">Ki Távo</a></h6>
                            <div class="meta meta-2">
                                <div class="date">
                                    <i class="fa fa-clock-o"></i> 2022. szept. 13.
                                </div>
                                <a href="#" class="author">
                                    <i class="fa fa-user"></i> Fináli Gábor
                                </a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="top-post-wrap top-post-wrap-4 monday-lessons">
                        ...
                        <div class="top-post-details">
                            ...
                            <h6><a href="#">Áron és a hétágú gyertyatartó, Behaalotcha hetiszakasza</a></h6>
                            <div class="meta meta-2">
                                <div class="date">
                                    <i class="fa fa-clock-o"></i> 2022. jún. 13.
                                </div>
                                <a href="#" class="author">
                                    <i class="fa fa-user"></i> Fináli Gábor
                                </a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="top-post-wrap top-post-wrap-4 monday-lessons">
                        ...
                        <div class="top-post-details">
                            <a class="tag" href="#">Love Care</a>
                            <h6><a href="#">Bamidbar</a></h6>
                            <div class="meta meta-3">
                                <div class="date">
                                    <i class="fa fa-clock-o"></i> 2022. máj. 31.
                                </div>
                                <a href="#" class="author">
                                    <i class="fa fa-user"></i> Fináli Gábor
                                </a>
...
<section>
    <div class="top-fashion-area pd-top-70 pd-bottom-50" id="programok">
        <div class="facebook-link-box text-center">
            <a target="_blank" class="boaz-page-link"
                href="https://www.facebook.com/hunyaditeri.zsinagoga">Programjaink</a>
        </div>
        <div class="container top-fashion-area__container--d-none">
            <div class="section-title section-title-4 style-4">
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-7 align-self-center text-left text-md-right">
                        <div class="top-fashion-tab d-inline-block">
                            <ul class="nav nav-tabs">
                                <li><a class="active" data-toggle="tab" href="#fashion7">Spa</a>
                                </li>
                                <li><a data-toggle="tab" href="#fashion8">Foods</a>
                                </li>
                                <li><a data-toggle="tab" href="#fashion9">Makeup</a>
                                </li>
                                <li><a data-toggle="tab" href="#fashion10">Beauty</a>
                                </li>
                                <li><a data-toggle="tab" href="#fashion11">Life Style</a>
                                </li>
                                <li><a data-toggle="tab" href="#fashion12">Music</a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <div class="category-area pd-bottom-40" id="csutortoki-orak">
        <div class="container">
            <div class="section-title section-title-4 style-2">
                <div class="row">
                    <div class="col-sm-8">
                        <h5 class="title">Vendégségben, vendégeink</h5>
                    </div>
                    <div class="col-sm-4 text-sm-right align-self-center">
                        <a class="see-all-btn float-sm-right">legfrissebb videók </a>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="top-post-wrap top-post-wrap-4 monday-lessons">
                        <div class="thumb">
                            <div class="overlay br-10"></div>
                            <iframe src="https://www.youtube.com/embed/fqJr6pnJ9Tc" title="YouTube video player"
                                frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowfullscreen></iframe>
                        </div>
                        <div class="top-post-details">
                            <a class="tag" href="#">Love Care</a>
                            <h6><a href="#">"Mit rejt a fátyol, mi lehet mögötte? - Az igazság" - Dr. Radvánszki Péter
                                    rabbi</a></h6>
                            <div class="meta meta-2">
                                <div class="date">
                                    <i class="fa fa-clock-o"></i> 2022. szept. 11.
                                </div>
                                <a href="#" class="author">
                                    <i class="fa fa-user"></i> Dr. Radvánszki Péter
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="top-post-wrap top-post-wrap-4 monday-lessons">
                        <div class="thumb">
                            <div class="overlay br-10"></div>
                            <iframe src="https://www.youtube.com/embed/7-ME1CYYFHg" title="YouTube video player"
                                frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowfullscreen></iframe>
                        </div>
                        <div class="top-post-details">
                            <a class="tag" href="#">MackUp</a>
                            <h6><a href="#">Quo vadis Izrael? Robert Castel előadása az Ohél Ávráhám zsinagógában</a>
                            </h6>
                            <div class="meta meta-2">
                                <div class="date">
                                    <i class="fa fa-clock-o"></i> 2022. szept. 29.
                                </div>
                                <a href="#" class="author">
                                    <i class="fa fa-user"></i> Robert Castel
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="top-post-wrap top-post-wrap-4 monday-lessons">
                        <div class="thumb">
                            <div class="overlay br-10"></div>
                            <iframe src="https://www.youtube.com/embed/eFmAuBELv9s" title="YouTube video player"
                                frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowfullscreen></iframe>
                        </div>
                        <div class="top-post-details">
                            <a class="tag" href="#">Love Care</a>
                            <h6><a href="#">Ep. 33. Ékev - Beszélgetés Fináli Gáborral</a></h6>
                            <div class="meta meta-3">
                                <div class="date">
                                    <i class="fa fa-clock-o"></i> 2021. júl. 29.
                                </div>
                                <a href="#" class="author">
                                    <i class="fa fa-user"></i> A.J. Megyeri
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="section-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h5 class="title">Top Fashion Stories</h5>
                            </div>
                            <div class="col-sm-4 text-sm-right align-self-center">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="media-post-wrap-3 media shadow-none">
                                <div class="thumb">
                                    <img src="assets/img/top-post/42.png" alt="img">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="meta meta-3">
                                        <div class="date mr-2">
                                            <i class="fa fa-clock-o"></i> 11 Jun, 2020 <span>|</span>
                                        </div>
                                        <a href="#" class="author mr-0">
                                            <i class="fa fa-user"></i> Alex Nuya <span>|</span>
                                        </a>
                                        <div class="Length">
                                            Length: 9 Mins
                                        </div>
                            ...
                            <div class="media-post-wrap-3 media shadow-none">
                                <div class="thumb">
                                    <img src="assets/img/top-post/43.png" alt="img">
                                    <a class="tag tag-yellow mt-3" href="#">Working</a>
                                </div>
                                <div class="media-body">
                                    <h6><a href="#">Gym is the main part fo our life: 10 best tips can make strong
                            ...
                            <div class="media-post-wrap-3 media shadow-none">
                                <div class="thumb">
                                    <img src="assets/img/top-post/44.png" alt="img">
                                    <a class="tag tag-yellow mt-3" href="#">Working</a>
                                </div>
                                <div class="media-body">
                                    <h6><a href="#">Gym is the main part fo our life: 10 best tips can make strong
                            ...
                            <div class="media-post-wrap-3 media shadow-none">
                                <div class="thumb">
                                    <img src="assets/img/top-post/45.png" alt="img">
                                    <a class="tag tag-yellow mt-3" href="#">Working</a>
                                </div>
                                <div class="media-body">
                                    <h6><a href="#">Gym is the main part fo our life: 10 best tips can make strong
                    ...
                    <div class="post-slider owl-carousel owl-theme">
                        <div class="item">
                            <div class="top-post-wrap top-post-wrap-4">
                                <div class="thumb">
                                    <div class="overlay br-10"></div>
                                    <img src="assets/img/top-post/46.png" alt="img">
                                </div>
                                <div class="top-post-details">
                                    <a class="tag" href="#">MackUp</a>
